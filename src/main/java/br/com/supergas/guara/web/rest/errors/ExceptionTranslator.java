package br.com.supergas.guara.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof br.com.supergas.guara.service.EmailAlreadyUsedException ||
            ex instanceof br.com.supergas.guara.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof br.com.supergas.guara.service.InvalidPasswordException
